...
% compute spectrogram
[freq,freq2,freq3,freq4,zlim] = spectrogram_automation_eventtype_lowfreq(input1,input2,input3,input4,freqrange,channel);
...
%% 30-100 Hz
freqrange = [30:1:100]; 
[freq,freq2,freq3,freq4,zlim] = spectrogram_automation_eventtype(input1,input2,input3,input4,freqrange,channel);
