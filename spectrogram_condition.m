...
% compute spectrogram
[freq,freq2,zlim] = spectrogram_automation_condition_lowfreq(input1,input2,freqrange,channel);
...
[freq,freq2,zlim] = spectrogram_automation_condition(input1,input2,freqrange,channel);
